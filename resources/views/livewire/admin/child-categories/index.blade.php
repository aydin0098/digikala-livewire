...
<div>
    ...
    <div class="row match-height">
        <div class="col-md-8 col-12">
            <div class="card" style="height: auto">
                <div class="card-header">
                    <h4 class="card-title">لیست دسته های کودک</h4>
                </div>
                                            ...
                                            <table class="table table-hover-animation mb-0">
                                                ...
                                                @foreach($categories as $cat)
                                                    <tr>
                                                        ...
                                                        <td><span class="badge badge-info">{{$cat->subcategories()->value('title')}}</span></td>
                                                        <td>
                                                            @if($cat->status ==1)
                                                        ...
                                                        <td>
                                                            ...
                                                            <a href="{{route('admin.childCat.update',$cat->id)}}" class="fa fa-edit"></a>
                                                        </td>
                                                    </tr>
                                                @endforeach
                                                </tbody>
        ...
        <div class="col-md-4 col-12">
            <div class="card" style="height: auto">
                <div class="card-header">
                    <h4 class="card-title">دسته کودک جدید</h4>
                </div>
                <div class="card-content">
                    <div class="card-body">
